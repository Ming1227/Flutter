        ...
        builder: (context, themeInfo, child) {
          ...
          return MaterialApp(
            ...
            routes: {
              ...
              'shadermask_page': (context) => ShaderMaskPage(),
              'stepper_page': (context) => StepperPage(),
              'stream_builder_page': (context) => StreamBuilderPage(),
              ...
              'reorderablelist_page': (context) => ReorderableListViewPage(),
              ...
              'sliver_fixed_extent_list_page': (context) =>
